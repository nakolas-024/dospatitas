import { e as createComponent, f as createAstro, m as maybeRenderHead, h as addAttribute, s as spreadAttributes, r as renderTemplate, n as renderComponent, l as renderScript, o as renderSlot, k as renderHead } from './astro/server_DVBAnwcH.mjs';
import 'kleur/colors';
/* empty css                         */
import 'clsx';
...
}, "C:/Users/Luctus Umbram/Desktop/astro pages/DOSPATITAS/dospatitas.cl/src/components/Icon.astro", void 0);
...
}, "C:/Users/Luctus Umbram/Desktop/astro pages/DOSPATITAS/dospatitas.cl/src/components/Header.astro", void 0);
...
}, "C:/Users/Luctus Umbram/Desktop/astro pages/DOSPATITAS/dospatitas.cl/src/components/Footer.astro", void 0);

const $$HowToBuyModal = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div id="how-to-buy-modal" class="modal-overlay hidden" data-astro-cid-bb3nzyrh> <div class="modal-content" data-astro-cid-bb3nzyrh> <button class="modal-close-btn" aria-label="Cerrar modal" data-astro-cid-bb3nzyrh>×</button> <h3 data-astro-cid-bb3nzyrh>¿Cómo Comprar?</h3> <ol class="steps-list" data-astro-cid-bb3nzyrh> <li data-astro-cid-bb3nzyrh><strong data-astro-cid-bb3nzyrh>Explora los diseños:</strong> Navega por nuestro catálogo y elige tus carnets favoritos.</li> <li data-astro-cid-bb3nzyrh><strong data-astro-cid-bb3nzyrh>Añade a tu pedido:</strong> Usa el botón "Agregar al carro" en cada producto que te guste.</li> <li data-astro-cid-bb3nzyrh><strong data-astro-cid-bb3nzyrh>Revisa tu pedido:</strong> Haz clic en el botón flotante de WhatsApp para ver tu selección.</li> <li data-astro-cid-bb3nzyrh><strong data-astro-cid-bb3nzyrh>Envíanos tu pedido:</strong> Presiona "Hacer Pedido" para enviarnos un mensaje de WhatsApp con tu lista.</li> <li data-astro-cid-bb3nzyrh><strong data-astro-cid-bb3nzyrh>Coordinamos por WhatsApp:</strong> Nos pondremos en contacto contigo para confirmar los datos de personalización y el pago.</li> </ol> </div> </div> ${renderScript($$result, "C:/Users/Luctus Umbram/Desktop/astro pages/DOSPATITAS/dospatitas.cl/src/components/HowToBuyModal.astro?astro&type=script&index=0&lang.ts")} `;
}, "C:/Users/Luctus Umbram/Desktop/astro pages/DOSPATITAS/dospatitas.cl/src/components/HowToBuyModal.astro", void 0);

const $$CartButton = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div id="cart-button" class="cart-button" title="Ver carrito" data-astro-cid-4b4iadpb> ${renderComponent($$result, "Icon", $$Icon, { "name": "shopping-cart", "size": 28, "data-astro-cid-4b4iadpb": true })} <span id="cart-counter" class="cart-counter hidden" data-astro-cid-4b4iadpb>0</span> </div> ${renderScript($$result, "C:/Users/Luctus Umbram/Desktop/astro pages/DOSPATITAS/dospatitas.cl/src/components/CartButton.astro?astro&type=script&index=0&lang.ts")} `;
}, "C:/Users/Luctus Umbram/Desktop/astro pages/DOSPATITAS/dospatitas.cl/src/components/CartButton.astro", void 0);

const $$Cart = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div id="cart-panel" class="cart-panel" aria-hidden="true" data-astro-cid-ue5255xy> <div class="panel-header" data-astro-cid-ue5255xy> <h3 data-astro-cid-ue5255xy>Tu Pedido</h3> <button id="close-cart-btn" class="close-btn" aria-label="Cerrar carrito" data-astro-cid-ue5255xy>×</button> </div> <div id="cart-items-container" class="cart-items-container" data-astro-cid-ue5255xy></div> <div class="panel-footer" data-astro-cid-ue5255xy> <a id="whatsapp-checkout-btn" href="#" class="whatsapp-btn disabled" target="_blank" rel="noopener noreferrer" data-astro-cid-ue5255xy>
Hacer Pedido por WhatsApp
</a> </div> </div> ${renderScript($$result, "C:/Users/Luctus Umbram/Desktop/astro pages/DOSPATITAS/dospatitas.cl/src/components/cart.astro?astro&type=script&index=0&lang.ts")} `;
}, "C:/Users/Luctus Umbram/Desktop/astro pages/DOSPATITAS/dospatitas.cl/src/components/cart.astro", void 0);

const $$ProductModal = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div id="product-modal" class="modal-overlay hidden" aria-hidden="true" data-astro-cid-yycpc3m6> <div class="modal-content" role="dialog" aria-modal="true" data-astro-cid-yycpc3m6> <button id="modal-close-btn" class="modal-close-btn" aria-label="Cerrar modal" data-astro-cid-yycpc3m6>×</button> <div id="modal-product-content" class="product-view" data-astro-cid-yycpc3m6> <div class="img-wrapper" data-astro-cid-yycpc3m6> <img id="modal-img" src="" alt="Imagen del producto" data-astro-cid-yycpc3m6> </div> <h3 id="modal-title" data-astro-cid-yycpc3m6></h3> <button id="add-to-cart-modal-btn" class="add-to-cart-modal" data-astro-cid-yycpc3m6>Añadir al carrito 🛒</button> </div> </div> </div> `;
}, "C:/Users/Luctus Umbram/Desktop/astro pages/DOSPATITAS/dospatitas.cl/src/components/ProductModal.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="es"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>', '</title><meta name="description"', '><link rel="icon" type="image/svg+xml" href="/favicon.svg"><link rel="canonical"', '><meta name="generator"', '><!-- Fuente --><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;700&display=swap" rel="stylesheet">', "</head> <body> ", " ", " ", " <!-- Modales y componentes --> ", " ", " ", " ", ' <!-- BOTONES FLOTANTES --> <a href="https://wa.me/+56966306409" class="floating-btn whatsapp-btn" target="_blank" rel="noopener noreferrer" aria-label="Contactar por WhatsApp">\n\u{1F4AC}\n</a> <button id="open-cart" class="floating-btn cart-btn" aria-label="Ver carrito">\n\u{1F6D2}\n</button> <script>\n      document.addEventListener("DOMContentLoaded", () => {\n        const cartPanel = document.getElementById("cart-panel");\n        const openCart = document.getElementById("open-cart");\n        if (cartPanel && openCart) {\n          openCart.addEventListener("click", () => {\n            cartPanel.classList.add("is-open");\n          });\n        }\n      });\n    <\/script>  </body> </html>'])), fullTitle, addAttribute(description, "content"), addAttribute(currentUrl, "href"), addAttribute(Astro2.generator, "content"), renderHead(), renderComponent($$result, "Header", $$Header, {}), renderSlot($$result, $$slots["default"]), renderComponent($$result, "Footer", $$Footer, {}), renderComponent($$result, "HowToBuyModal", $$HowToBuyModal, {}), renderComponent($$result, "ProductModal", $$ProductModal, {}), renderComponent($$result, "CartButton", $$CartButton, {}), renderComponent($$result, "Cart", $$Cart, {}));
}, "C:/Users/Luctus Umbram/Desktop/astro pages/DOSPATITAS/dospatitas.cl/src/layouts/Layout.astro", void 0);

export { $$Layout as $, $$Header as a, $$Icon as b, $$Footer as c };
